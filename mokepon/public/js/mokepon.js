...
function seleccionarMascotaJugador() {
    ...
    seleccionarMokepon(mascotaJugador) // es para comunicar la seleccion del mokepon al backend
...
function seleccionarMokepon(mascotaJugador){
    // concatenas cadenas con la `` comillas invertidas se llama TEMPLATE STRING con el simbolo de dollar $ une la cadena fija con lo que haya dentro
    //envia solo datos al servidor
    fetch(`http://localhost:8080/mokepon/${jugadorId}`, {
        method: 'post', //cambiar el metodo del fetch a tipo post
        headers: {
...
function pintarCanvas() {
    ...
    enviarPosicion(mascotaJugadorObjeto.x, mascotaJugadorObjeto.y)
        ...
        //por cada uno de los mokepones se ejecuta la funcion, el forEach recoorre la lista y ejecuta la función con cada uno de ellos
        ...
        if (res.ok){
            res.json()
                .then(function({ enemigos }){
                    ...
                    mokeponesEnemigos = enemigos.map(function(enemigo){ // .map: similar a forEach, va retornar un valor, generando una lista con el mismo numero de elementos que lista original
